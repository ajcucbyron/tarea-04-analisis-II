...
namespace Ddd.ManejoDeTienda.Dominio.Agregados
{
    ...
    /// </summary>
    public class Departamento : EntidadBase<Guid>, IRaizDeAgregado
    {
        ...
        public Departamento(Guid tiendaId, string primerNombre, string apellido, string telefono,
            string email, string titulo, DateTime fechaDeComienzo, DateTime? fechaDeTerminacion = null)
        {
            ...
            if (fechaDeTerminacion != null)
                TerminarDepartamento((DateTime)fechaDeTerminacion);
        }
        ...
        public void TerminarDepartamento(DateTime fechaDeTerminacion, Action funcion = null)
        {
