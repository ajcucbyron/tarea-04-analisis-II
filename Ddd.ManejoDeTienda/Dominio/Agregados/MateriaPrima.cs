...
namespace Ddd.ManejoDeTienda.Dominio.Agregados
{
    ...
    /// </summary>
    public class MateriaPrima : EntidadBase<Guid>, IRaizDeAgregado
    {
        ...
        public MateriaPrima(Guid tiendaId, string primerNombre, string apellido, string telefono,
            string email, string titulo, DateTime fechaDeComienzo, DateTime? fechaDeTerminacion = null)
        {
            ...
            if (fechaDeTerminacion != null)
                TerminarMateriaPrima((DateTime)fechaDeTerminacion);
        }
        ...
        public void TerminarMateriaPrima(DateTime fechaDeTerminacion, Action funcion = null)
        {
