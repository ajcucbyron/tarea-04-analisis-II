...
namespace Ddd.ManejoDeTienda.Dominio.Agregados
{
    ...
    /// </summary>
    public class Municipio : EntidadBase<Guid>, IRaizDeAgregado
    {
        ...
        public Municipio(Guid tiendaId, string primerNombre, string apellido, string telefono,
            string email, string titulo, DateTime fechaDeComienzo, DateTime? fechaDeTerminacion = null)
        {
            ...
            if (fechaDeTerminacion != null)
                TerminarMunicipio((DateTime)fechaDeTerminacion);
        }
        ...
        public void TerminarMunicipio(DateTime fechaDeTerminacion, Action funcion = null)
        {
