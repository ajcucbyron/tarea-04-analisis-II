...
namespace Ddd.ManejoDeTienda.Dominio.Agregados
{
    ...
    /// </summary>
    public class Proveedor : EntidadBase<Guid>, IRaizDeAgregado
    {
        ...
        public Proveedor(Guid tiendaId, string primerNombre, string apellido, string telefono,
            string email, string titulo, DateTime fechaDeComienzo, DateTime? fechaDeTerminacion = null)
        {
            ...
            if (fechaDeTerminacion != null)
                TerminarProveedor((DateTime)fechaDeTerminacion);
        }
        ...
        public void TerminarProveedor(DateTime fechaDeTerminacion, Action funcion = null)
        {
