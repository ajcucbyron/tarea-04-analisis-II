...
namespace Ddd.ManejoDeTienda.Dominio.Agregados
{
    ...
    /// </summary>
    public class Producto : EntidadBase<Guid>, IRaizDeAgregado
    {
        ...
        public Producto(Guid tiendaId, string primerNombre, string apellido, string telefono,
            string email, string titulo, DateTime fechaDeComienzo, DateTime? fechaDeTerminacion = null)
        {
            ...
            if (fechaDeTerminacion != null)
                TerminarProducto((DateTime)fechaDeTerminacion);
        }
        ...
        public void TerminarProducto(DateTime fechaDeTerminacion, Action funcion = null)
        {
