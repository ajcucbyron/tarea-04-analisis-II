...
namespace Ddd.ManejoDeTienda.Dominio.Agregados
{
    ...
    /// </summary>
    public class Pedido : EntidadBase<Guid>, IRaizDeAgregado
    {
        ...
        public Pedido(Guid tiendaId, string primerNombre, string apellido, string telefono,
            string email, string titulo, DateTime fechaDeComienzo, DateTime? fechaDeTerminacion = null)
        {
            ...
            if (fechaDeTerminacion != null)
                TerminarPedido((DateTime)fechaDeTerminacion);
        }
        ...
        public void TerminarPedido(DateTime fechaDeTerminacion, Action funcion = null)
        {
