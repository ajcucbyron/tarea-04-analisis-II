...
namespace Ddd.ManejoDeTienda.Dominio.Agregados
{
    ...
    /// </summary>
    public class Vehiculo : EntidadBase<Guid>, IRaizDeAgregado
    {
        ...
        public Vehiculo(Guid tiendaId, string primerNombre, string apellido, string telefono,
            string email, string titulo, DateTime fechaDeComienzo, DateTime? fechaDeTerminacion = null)
        {
            ...
            if (fechaDeTerminacion != null)
                TerminarVehiculo((DateTime)fechaDeTerminacion);
        }
        ...
        public void TerminarVehiculo(DateTime fechaDeTerminacion, Action funcion = null)
        {
