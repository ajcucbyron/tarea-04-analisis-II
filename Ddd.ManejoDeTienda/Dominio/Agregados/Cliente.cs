...
namespace Ddd.ManejoDeTienda.Dominio.Agregados
{
    ...
    /// </summary>
    public class Cliente : EntidadBase<Guid>, IRaizDeAgregado
    {
        ...
        public Cliente(Guid tiendaId, string primerNombre, string apellido, string telefono,
            string email, string titulo, DateTime fechaDeComienzo, DateTime? fechaDeTerminacion = null)
        {
            ...
            if (fechaDeTerminacion != null)
                TerminarCliente((DateTime)fechaDeTerminacion);
        }
        ...
        public void TerminarCliente(DateTime fechaDeTerminacion, Action funcion = null)
        {
