...
namespace Infraestructura.SQL.Data
{
    ...
    {
        public static Task EnableIdentityInsert<T>(this DbContext context) => SetIdentityInsert<T>(context, enable: false);
        ...
        {
            return context.Database.ProviderName.Contains("Sql");
        }
